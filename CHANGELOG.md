...
- **版本签名**：`Skiav7.0` → `Skiav8`（`1824+v24+EMv18+EEv56+Skiav8`）
- **Android versionCode**：65 → 66，versionName：0.65.0 → 0.66.0
...
- **PluginAvailableWarn 配置项**（源自 ee commit `0abdff8`）
...
- **TOOLTIP 默认设置回退**（源自 ee commit `07e58ac`）
