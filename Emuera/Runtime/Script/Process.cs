...
internal sealed partial class Process(EmueraConsole view)
{
	...
	public async Task<bool> Initialize(StreamWriter logWriter)
	{
		...
		try
		{
			...
			if (Program.AnalysisMode)
				...
				noError = await loader.LoadErbDir(Program.ErbDir, Config.DisplayReport, Config.UseLazyLoading, labelDic);
	...
	public async Task ReloadErb()
	{
		...
		await loader.LoadErbDir(Program.ErbDir, false, Config.UseLazyLoading, labelDic);
		console.ReadAnyKey();
	}
